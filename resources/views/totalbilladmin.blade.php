                            ...
                            <table class="table">
                                ...
                                <tbody id="body">
                                  @foreach($bill as $value)
                                   <tr>
                                   <td>{{$value->IDBill}}</td>
                                   <td>{{$value->NameTour}}</td>
                                   <td><img src="{{$value->Image}}" style="width:70px;height:60px;"></td>
                                   <td>{{$value->Day}}</td>
                                   <td><a href="http://localhost/NKTravel/public/detailbilladmin/{{$value->IDBill}}"><img src="http://icons.iconarchive.com/icons/icons8/windows-8/32/Data-View-Details-icon.png" alt=""></a></td>
                                   </tr>
                                  @endforeach
                                </tbody>
                            </table>
