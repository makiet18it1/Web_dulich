          ...
          <li><a href="{{route('message')}}"><i class="fa fa-comments"></i><span>{{count($contact)}}</span></a></li>
            ...
            <li><a href="#"><i data-show="show-side-navigation1" class="fa fa-bars show-side-btn" style="margin-top: 7px;"></i></a></li>
                        ...
                        <div class="content-table" style="margin-top: 20px;">
                            ...
                            {
                              if ($a=='Đang hoạt động') {
                                 $kq="style='background-color:#56aaff;color:black;padding:5px;border-radius:5px;font-weight:bold;'";
                              }
                              else{
                                $kq="style='background-color:#ff5656;color:white;padding:5px;border-radius:5px;font-weight:bold;'";
                              }
                              return $kq;
                            }
                            ?>
                            <tbody id="body">
                                    ...
                                    <tr>
                                        <td>{{$values->IDcustomer}}</td>
                                        <td>{{$values->NameCustomer}}</td>
                                        <td>{{$values->Email}}</td>
                                        <td>{{$values->Phone}}</td>
