            ...
            <li><a href="#"><i data-show="show-side-navigation1" class="fa fa-bars show-side-btn" style="margin-top: 7px;"></i></a></li>
                    ...
                    <div class="content1">
                      <div class="row">
                        ...
                        <div class="tab">
                    <button class="tablinks" onclick="openCity(event, 'description')" id="defaultOpen"><b>Thông tin chi tiết</b></button>
                    <button class="tablinks" onclick="openCity(event, 'guide')"><b>Đánh giá khách hàng</b></button>
                       </div>
                  
                  <div id="description" class="tabcontent">
                    <form action="{{url()->route('updatearticleadmin')}}" method="POST">
                        {{csrf_field()}}
                    <table>
                        <tr>
                           <td>ID:</td>
                           <td><input type="text" name="id" id="id" value="{{$detail[0]['IDArticle']}}" readonly></td>
                        </tr>
                        <tr>
                            <td>Hình ảnh:</td>
                            <td><img src="{{$detail[0]['Image']}}" style="width:100px;height:80px;margin-bottom:7px;" id="image">
                                <input type="file" name="image"  onchange="readURL(this)">
                            </td>
                        </tr>
                        <tr>
                            <td>Tên bài viết:</td>
                            <td><input type="text" name="name" id="name" value="{{$detail[0]['NameArticle']}}"></td>
                        </tr>
                        <tr>
                            <td>Người viết:</td>
                            <td><input type="text" name="writer" id="id" value="{{$detail[0]['Writer']}}" readonly></td>
                        </tr>
                        <tr>
                            <td>Mô tả: </td>
                        <td><textarea name="des" id="" style="width:50%;height:150px;padding:7px;">{{$detail[0]['Review']}}</textarea></td>
                        </tr>
                        <tr>
                            <td>Nội dung</td>
                        <td><textarea name="editor1">{{$detail[0]['Content']}}</textarea></td>
                        </tr>

                    </table>
                  <p  align="center"><input type="submit" value="Lưu" class="btn btn-basic"><a href="{{route('totalarticle')}}" style="color:black;text-decoration: none"><input type="button" value="Thoát" class="btn btn-basic" style="margin-left:5px;"></a></p>
                </form>
                  </div>
                       ...
                       <table class="table">
                            ...
                            <tbody>
                             @foreach($comment as $value)
                                 <tr>
                                     <td>
                                         <div class="col-sm-2"><img src="http://localhost/NKTravel/public/image/avatar.jpg" class="avatar"></div>
                                         <div class="col-sm-10">
                                         <p>{{$value->Who}}</p>
                                         <p>{{$value->Email}}</p>
                                         </div>
                                    ...
                                    <td>
                                      <p style="color:#999">Viết vào ngày: {{$value->created_at}}</p>
                                      <p>{{$value->Content}}</p>
                                      <p><a href="#" style="color:blue;text-decoration: none">Trả lời</a> | <a href="#" style="color:blue;text-decoration: none">Xóa</a></p>
                                    </td>
                                 </tr>
                              @endforeach
                            </tbody>
