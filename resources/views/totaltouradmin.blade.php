          ...
          <li><a href="{{route('message')}}"><i class="fa fa-comments"></i><span>{{count($contact)}}</span></a></li>
            ...
            <li><a href="#"><i data-show="show-side-navigation1" class="fa fa-bars show-side-btn" style="margin-top: 7px;"></i></a></li>
                        ...
                        <div class="content-table" style="margin-top: 20px;">
                                ...
                                <a href="{{route('addtourinterface')}}" align="center" style="float: right;color:#ccc;"><button style="background-color: inherit;outline: none;border: none;font-size: 16px;" type="button"><img src="http://localhost/NKTravel/public/image/plus-3-24.png" class="image" style="margin-right: 3px;margin-top: -2px;">Thêm tour</button></a>
                                <table class="table">
                                <thead>
                                <tr>
                                    <th>IDTour</th>
                            ...
                            <tbody id="body">
                                    ...
                                    <tr>
                                       ...
                                       <td><a href="/NKTravel/public/deletetouradmin/{{$values->IDTour}}"><img src='http://localhost/studentmanager/Image/recycle.png' ></a></td>
                                    </tr>
                                 @endforeach
                            </tbody>
                            </table>
