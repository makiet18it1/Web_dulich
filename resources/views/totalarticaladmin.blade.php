                            ...
                            <table class="table">
                                ...
                                <tbody id="body">
                                        ...
                                        <tr>
                                             ...
                                             <td>{{$values->Writer}}</td>
                                             <td>{{$values->Date}}</td>
                                        <td><a href="http://localhost/NKTravel/public/detailarticleadmin/{{$values->IDArticle}}"><img src="http://icons.iconarchive.com/icons/icons8/windows-8/32/Data-View-Details-icon.png" alt=""></a></td>
                                             <td><a href="http://localhost/NKTravel/public/deletearticleadmin/{{$values->IDArticle}}"><img src="http://icons.iconarchive.com/icons/double-j-design/origami-colored-pencil/32/red-cross-icon.png" alt=""></a></td>
                                        </tr>    
                                        @endforeach
                                </tbody>
                            </table>
