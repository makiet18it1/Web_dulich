...
<body>
        <aside class="side-nav" id="show-side-navigation1">
                ...
                <ul class="categories">
                  <li><img src="http://localhost/NKTravel/public/image/chart.png" class="image"><a href="#"> Biểu đồ</a>
                  </li>
              ...
              <section id="contents">
                    ...
                    <form action="{{url()->route('updatetouradmin1')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
